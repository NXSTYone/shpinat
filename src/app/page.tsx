...
const menuSections = [
  {
    ...
    text: "Авторские полезные блюда из свежих ингредиентов. Подарочные сертификаты для вашей семьи и друзей.",
    href: "/menu/dishes",
  },
  {
    icon: Package,
  ...
  },
  {
    icon: Leaf,
    title: "Эко-продукты",
    text: "Домашние яйца, хлеб, зелень и натуральные продукты.",
    href: "/menu/products",
  },
];
      ...
      <section id="cart" className="mx-auto max-w-7xl px-5 pb-32">
        <div className="rounded-[3rem] border border-[#b89c6d] bg-white/20 p-8 text-center shadow-[0_30px_100px_rgba(74,53,24,0.22)] backdrop-blur-xl md:p-14">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg leading-8 text-[#355f28]">
            Выберите и добавьте товар в корзину для оформления и оплаты заказа.
          </p>
