    ...
    <main className="min-h-screen bg-[#cdb78f] px-5 py-10 text-[#355f28]">
      <div className="mx-auto max-w-4xl rounded-[2rem] bg-white/35 p-6 shadow-2xl backdrop-blur-xl md:p-10">
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          <a
            href="/privacy"
            className="rounded-full bg-[#39A935] px-6 py-3 font-black text-white"
          >
          ...
          <a
            href="/"
            className="rounded-full border border-[#b89c6d] bg-white/30 px-6 py-3 font-black text-[#1f7a32]"
          >
            На главную
          </a>
        </div>
