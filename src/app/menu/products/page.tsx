...
import { ecoProducts } from "@/data/products";
import { useCart } from "@/context/CartContext";

type Product = (typeof ecoProducts)[number];
            ...
            >
              ...
              <div className="p-7">
                ...
                <div className="mt-5 flex items-center gap-2 rounded-2xl bg-white/25 p-4 text-sm font-bold leading-6 text-[#355f28]">
                  ...
                  {product.seasonal
                    ? "Наличие и состав могут меняться в зависимости от сезона."
                    : "Постоянная позиция."}
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="font-bold leading-7 text-[#355f28]">
                      {selectedProduct.seasonal
                        ? "Наличие и состав могут меняться в зависимости от сезона и доступности свежих продуктов."
