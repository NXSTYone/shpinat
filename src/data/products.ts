...
- Сыры
- Яйца
- Крупы: бурый, чёрный рис, киноа, гречка, булгур, пророщенная зеленая гречка, чечевица, пшеница, пажитник
- Микрозелень
- Соус: оливковое или нерафинированное масло
...
export const sets = [
  {
    ...
    fullDescription:
      "Большой набор домашних и фермерских продуктов.",
    price: 890,
    image:
